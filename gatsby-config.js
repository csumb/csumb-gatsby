...
const gatsbyConfig = {
  siteMetadata: {
    ...
    overridePages: [
      ...
      'web/diploma-test',
      '/admissions',
      '/admissions/admissions-help-site',
      '/admissions/campus-tours-0',
      '/admissions/freshman-requirements',
      '/admissions/transfer-requirements',
      '/admissions/freshmen-important-dates-deadlines',
      '/admissions/transfer-student-important-dates-deadlines',
      '/admissions/determining-california-state-residency',
      '/admissions/graduate-credential-programs',
      '/cost',
      '/cost/how-make-payment',
      '/cost/tuition-fees',
      '/cost/faq',
      '/cost/other-payment-methods',
      '/cost/installment-payment-plan',
      '/csc',
      '/csc/ottercard',
    ],
    eventCategories: [
